...
<head>
    ...
    <title> Spar Grocery Store </title>
    <meta name="Description" content="A management system for spar grocery">
    <meta name="Author" content="">
    <meta name="keywords" content="Spar, Management System, Admin, Store keeper">
                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="signin-username"
                                            placeholder="Please enter username" name="username" required>
                                    </div>
                                    <div class="col-xl-12 mb-2">
                                        <label for="signin-password" class="form-label text-default d-block">Password<a
                                                href="reset-password.html" class="float-end text-danger">Forget password
                                                ?</a></label>
                                        <div class="input-group">
                                            <input type="password" class="form-control form-control-lg"
                                                id="signin-password" placeholder="Please enter password" name="password"
                                                required>
                                    ...
                                    <div class="col-xl-12 d-grid mt-2">
                                        <button class="btn btn-lg btn-primary" name="signin">Sign In</button>
                                    </div>
                                </div>
                            </form>
                            <div class="text-center">
                                <p class="text-muted mt-3">Dont have an account? <a href="sign-up.html"
